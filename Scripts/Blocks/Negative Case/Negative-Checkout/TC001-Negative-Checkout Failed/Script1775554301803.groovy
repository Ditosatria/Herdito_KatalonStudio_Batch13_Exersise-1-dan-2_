...
WebUI.click(findTestObject('Object Repository/Page Checkout/label_Cash on Delivery'))

WebUI.click(findTestObject('Object Repository/Page Checkout/btn_input_PayPal Express Checkout_place_order'))

WebUI.click(findTestObject('Object Repository/Page Checkout/strong_Billing First Name'))

WebUI.verifyElementText(findTestObject('Object Repository/Page Checkout/li_Billing First Name is a required field'), 'Billing First Name is a required field.')
